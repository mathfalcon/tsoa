...
import 'mocha';
import { ReferenceTransformer } from '@mathfalcon/tsoa-cli/metadataGeneration/transformer/referenceTransformer';
import { GenerateMetadataError } from '@mathfalcon/tsoa-cli/metadataGeneration/exceptions';
